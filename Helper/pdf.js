...
function generateCustomerInformation(doc, invoice) {
  doc.fillColor("#444444").fontSize(20).text(invoice[0].userName, 50, 160);
  generateHr(doc, 185);
  ...
  doc
    ...
    .text(invoice[0].email, 150, customerInformationTop + 30);
...
function generateHr(doc, y) {
  doc.strokeColor("red").lineWidth(1).moveTo(50, y).lineTo(550, y).stroke();
}
